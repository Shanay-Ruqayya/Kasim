...
if ( ! class_exists( 'CFM_Hosting' ) ) :
	...
	class CFM_Hosting {
		...
		private function _load_hooks() {
			...
			// set show page.
			add_action( 'pre_get_posts', array( 'CFMH_Hosting_Sync_Front', 'index_page' ) );
			...
			// twitter + meta card.
			add_action( 'wp_head', array( 'CFMH_Hosting_Sync_Front', 'add_meta_card' ), 1 );
			...
			if ( is_admin() ) :
				...
				add_action( 'wp_ajax_manage-snippets', array( 'CFMH_Hosting_Publish_Episode', 'manage_snippets' ) );
				add_action( 'wp_ajax_edit-snippet', array( 'CFMH_Hosting_Publish_Episode', 'edit_snippet' ) );
				add_action( 'wp_ajax_delete-snippet', array( 'CFMH_Hosting_Publish_Episode', 'delete_snippet' ) );
				add_action( 'wp_ajax_ql-load-snippets', array( 'CFMH_Hosting_Publish_Episode', 'ql_load_snippets' ) );
