														...
														<div class="modal-body">
															...
															<div class="row">
																<div class="col-12">
																	...
																	<?php echo esc_html( '<div style="width: 100%; height: 170px; margin-bottom: 20px; border-radius: 10px; overflow:hidden;"><iframe style="width: 100%; height: 170px;" frameborder="no" scrolling="no" seamless src="https://player.captivate.fm/' . get_post_meta( $pid, 'cfm_episode_id', true ) . '"></iframe></div>' ); ?>
																	</div>
																</div>
															</div>
