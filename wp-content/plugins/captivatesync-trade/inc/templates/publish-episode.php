											...
											<div class="row align-items-center">
												...
												<div class="col-sm-6">
													<div class="input-group input-group-number">
														...
														<input type="text" id="itunesEpisodeSeason" name="itunesEpisodeSeason" min="0" max="1000" value="<?php echo ( $itunes_season ) ? esc_attr( $itunes_season ) : '0'; ?>" class="form-control input-number">
											...
											<div class="row align-items-center">
												...
												<div class="col-sm-6">
													<div class="input-group input-group-number">
														...
														<input type="text" id="itunesEpisodeNumber" name="itunesEpisodeNumber" min="0" max="1000" value="<?php echo ( $itunes_number ) ? esc_attr( $itunes_number ) : '0'; ?>" class="form-control input-number">
								...
								<div class="row">
									...
									<div class="col-md-6 order-2 order-md-1">
										<div class="text-left cfm-submit">
											<a href="<?php echo esc_url( admin_url( 'admin.php?page=cfm-hosting-podcasts' ) ); ?>" class="btn btn-outline-secondary float-left full-md-button">Cancel</a>
										</div>
									</div>
