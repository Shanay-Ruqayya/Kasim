...
final class Pie_Forms
    {
        ...
        */
        ...
        function add_action_links( $links, $file ) 
        {
            ...
            $links[] = '<a href="'. get_admin_url(null, 'admin.php?page=pf-settings') .'">'.(__("Settings","pie-forms")).'</a>';
            $links[] = '<a href="'. get_admin_url(null, 'admin.php?page=pf-aboutus') .'">'.(__("About Us","pie-forms")).'</a>';
            $links[] = '<a class="go-pro" href="https://pieforms.com/plan-and-pricing/">'.(__("Go Pro","pie-forms")).'</a>';
            return $links;
        }
