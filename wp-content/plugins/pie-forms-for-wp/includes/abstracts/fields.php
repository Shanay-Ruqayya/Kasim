...
abstract class PFORM_Abstracts_Fields {
	...
	public function field_new() {
		...
		$preview      = sprintf( '<div class="pie-forms-field pie-forms-field-%s %s %s" id="pie-forms-field-%s" data-field-id="%s" data-field-type="%s">', $field_type, $field_required, $field_class, $field['id'], $field['id'], $field_type );
