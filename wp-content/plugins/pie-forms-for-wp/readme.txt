...
== KEY FEATURES AVAILABLE IN FREE AND PRO VERSIONS WITH BASIC AND ADVANCED OPTIONS ==

* [**Data Entry Management**](https://pieforms.com/data-entry-management/)
* [**Prebuilt Form templates**](https://demo.pieforms.com)

== PREMIUM FEATURES: ==

* **[Advanced Fields](https://pieforms.com/advancedfields)**
* **[Block Users](https://pieforms.com/block-users/)**
* **[Conditional Logic](https://pieforms.com/conditionallogic/)**
* **[Limit Form Entries](https://pieforms.com/schedule-form/)**
* **[Schedule Forms](https://pieforms.com/schedule-form/)**
* **[File Upload](https://pieforms.com/fileupload/)**
* **[Date and Time Picker](https://pieforms.com/date-and-time-picker/)**
* **[Digital Signature](https://pieforms.com/digital-signature/)**
* **[Limit Form Entries From a Device](https://pieforms.com/limit-form-entries-from-a-device/)**
* **[Restrict Forms](https://pieforms.com/limit-form-entries-from-a-device/)**
* **Rating Field**
* **[Image Upload Field (Human Face Detector-AI)](https://pieforms.com/human-face-detector/)**

== EXTENSIONS FOR FREE: ==

* **[MailChimp Add-on](https://pieforms.com/mail-chimp/)**
...
* **[Paypal](https://www.paypal.com/pk/home)**
